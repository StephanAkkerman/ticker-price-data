...
def test_regular_session():
    ...
    with patch(
        "ticker_price_data.market_session._now_utc",
        return_value=_ts("2025-01-07 15:00:00"),
    ):
...
def test_pre_market():
    ...
    with patch(
        "ticker_price_data.market_session._now_utc",
        return_value=_ts("2025-01-07 13:00:00"),
    ):
...
def test_pre_market_start_boundary():
    ...
    with patch(
        "ticker_price_data.market_session._now_utc",
        return_value=_ts("2025-01-07 09:00:00"),
    ):
        assert get_us_stock_session() == "pre-market"
...
def test_pre_market_end_boundary():
    ...
    with patch(
        "ticker_price_data.market_session._now_utc",
        return_value=_ts("2025-01-07 14:29:00"),
    ):
        assert get_us_stock_session() == "pre-market"
...
def test_after_hours():
    ...
    with patch(
        "ticker_price_data.market_session._now_utc",
        return_value=_ts("2025-01-07 22:00:00"),
    ):
...
def test_after_hours_start_boundary():
    ...
    with patch(
        "ticker_price_data.market_session._now_utc",
        return_value=_ts("2025-01-07 21:00:00"),
    ):
        assert get_us_stock_session() == "after-hours"
...
def test_after_hours_end_boundary_is_closed():
    ...
    with patch(
        "ticker_price_data.market_session._now_utc",
        return_value=_ts("2025-01-08 01:00:00"),
    ):
...
def test_closed_weekend():
    ...
    with patch(
        "ticker_price_data.market_session._now_utc",
        return_value=_ts("2025-01-11 15:00:00"),
    ):
        assert get_us_stock_session() == "closed"
...
def test_closed_holiday():
    ...
    with patch(
        "ticker_price_data.market_session._now_utc",
        return_value=_ts("2025-07-04 15:00:00"),
    ):
        assert get_us_stock_session() == "closed"
...
def test_closed_before_pre_market():
    ...
    with patch(
        "ticker_price_data.market_session._now_utc",
        return_value=_ts("2025-01-07 07:00:00"),
    ):
        assert get_us_stock_session() == "closed"
